...
import { RiContactsFill, RiHomeHeartFill } from "react-icons/ri";
    ...
    return (
        ...
        <section className="home-banner w-full">
            <div className="pt-65  flex flex-col items-center justify-center h-full  ">
                <h1 className="text-purple-600 my-6 pt-8 text-center text 3xl md:text-4xl lg:text-5xl font-semibold border-fuchsia-100 pb-4 ">Em que posso ajudar?</h1>
                ...
                <Link to='/contato'><button className='bg-primary flex text-white px-6 rounded-full transition duration-700 hover:scale-105'>Contato<RiContactsFill className="justify mt-1" /></button></Link>
                </div>
            </div>
